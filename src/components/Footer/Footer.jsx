    ...
    <Container>
      <Row>
        <Col lg='3'>
          <div className='logo'>
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Ipsa praesentium ab mollitia vel.</p>
        ...
        <h5 className='footer__link--title'>Contacts</h5>
          ...
          <ListGroupItem className='ps-0 border-0 d-flex align-item-center gap-3'>
           <h6 className='mb-0 d-flex align-item-center gap-2'>
            ...
            <p className='mb-0'>Kolkota,India</p>
          </ListGroupItem>
          <ListGroupItem className='ps-0 border-0 d-flex align-item-center gap-3'>
           <h6 className='mb-0 d-flex align-item-center gap-2'>
              <span>
            ...
            <p className='mb-0'>dev.goswamiSouvhik@gmail.com</p>
          </ListGroupItem>
          <ListGroupItem className='ps-0 border-0 d-flex align-item-center gap-3'>
           <h6 className='mb-0 d-flex align-item-center gap-2'>
              <span>
        ...
        <Col lg='12' className='text-center pt-5'>
          <p className="copyright">Copyright{year}, design and develop by Souvhik Goswami. All rights reserved.</p>
        </Col>
      </Row>
    </Container>
  </footer>
